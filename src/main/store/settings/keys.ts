...
export const SETTINGS_KEY_THEME_MODE = 'themeMode'
...
export const SETTINGS_KEY_SHOW_CUSTOM_EXECUTION_TEAM = 'showCustomExecutionTeam'
export const SETTINGS_KEY_TOOL_PERMISSION_MODE = 'toolPermissionMode'
export const SETTINGS_KEY_DEFAULT_MCP_SERVERS_SEEDED = 'defaultMcpServersSeeded'
