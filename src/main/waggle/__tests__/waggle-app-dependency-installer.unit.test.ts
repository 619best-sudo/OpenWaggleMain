      ...
      skills: [
        {
          ...
          folderPath: path.join(projectPath, '.turing-machine/skills/frontend-implementer'),
          skillPath: path.join(projectPath, '.turing-machine/skills/frontend-implementer/SKILL.md'),
          hasScripts: false,
          enabled: true,
          loadStatus: 'ok',
        },
