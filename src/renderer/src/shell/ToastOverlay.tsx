...
export function ToastOverlay() {
  ...
  return (
    <div
      className={cn(
        'pointer-events-auto fixed right-5 top-16 z-[9999] flex items-center gap-2 rounded-lg border px-3.5 py-2.5 text-[12px] text-text-secondary shadow-lg',
    ...
    >
      ...
      {toastData.action && (
        <Button
          ...
          className="inline-flex cursor-pointer items-center gap-1 rounded px-1.5 py-0.5 text-[11px] font-medium text-accent transition-colors hover:bg-accent/10"
        >
