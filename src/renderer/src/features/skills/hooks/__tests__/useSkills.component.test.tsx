      ...
      createCatalog([
        {
          ...
          folderPath: '/tmp/project/.turing-machine/skills/broken-skill',
          skillPath: '/tmp/project/.turing-machine/skills/broken-skill/SKILL.md',
          hasScripts: false,
          enabled: true,
          loadStatus: 'error',
  ...
  it('invalidates the catalog and preserves the selected skill after toggling', async () => {
    const catalog = createCatalog([
      ...
      },
      {
        ...
        folderPath: '/tmp/project/.turing-machine/skills/skill-two',
        skillPath: '/tmp/project/.turing-machine/skills/skill-two/SKILL.md',
        hasScripts: false,
        enabled: false,
        loadStatus: 'ok',
      },
