...
describe('ChatTranscript t3-style scroll behavior', () => {
  ...
  it('hides the transcript debug button even when transcript debug is enabled', async () => {
    ...
    expect(screen.queryByRole('button', { name: 'Transcript Debug' })).not.toBeInTheDocument()
  })
