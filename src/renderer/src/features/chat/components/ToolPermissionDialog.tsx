...
export function ToolPermissionDialog({
  ...
  return (
    <div className="rounded-md border border-border/40 bg-bg-secondary p-3.5 shadow-none">
      <div className="mb-2.5 flex items-center gap-2">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-text-primary">Permission</p>
