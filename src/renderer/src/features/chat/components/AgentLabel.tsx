...
export function AgentLabel({ waggle }: AgentLabelProps) {
  if (waggle) {
    return (
      <div>
        <span className="home-panel-frame-soft inline-flex items-center gap-1.5 rounded-md bg-bg-secondary/20 px-2 py-1 text-[10px] font-medium text-text-primary/82">
          <div
